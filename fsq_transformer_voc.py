...
if __name__ == '__main__':
    ...
    batch_size = 256
    lr = 3e-4
    sample_img_freq = int(max_epochs/200)
    plot_freq = int(max_epochs/20)
    random_seed = 10101010
    resume_training_from_ckpt = True    

    hyperparam_dict = {}
    hyperparam_dict['img_size'] = img_size
    hyperparam_dict['patch_size'] = patch_size
    hyperparam_dict['patch_dim'] = patch_dim
    hyperparam_dict['seq_len'] = seq_len
    ...
    checkpoint_path = './ckpts/FSQ_Transformer' + hyperparam_str + '.pt' # path to a save and load checkpoint of the trained model         

    save_img_folder = './out_imgs_FSQ_Transformer' + hyperparam_str
